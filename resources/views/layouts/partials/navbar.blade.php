        ...
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          @foreach ($breadcrumbs as $breadcrumb)
            ...
            @else
              ...
              <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="{{route($breadcrumb['url']); }}">{{ $breadcrumb['name'] }}</a></li>
            @endif
          @endforeach
        </ol>
        
        {{-- <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">{{ request()->segments()[0] }}</a></li>
      ...
      <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
        <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            ...
            {{-- <div class="input-group input-group-outline">
              <label class="form-label">Type here to search...</label>
        ...
        <ul class="navbar-nav  justify-content-end">
          ...
          <li class="nav-item px-3 d-flex align-items-center">
            <a href="javascript:;" class="nav-link text-body p-0">
              <span>Welcome {{ Auth::user()->last_name }}, {{ Auth::user()->middle_name }} {{ Auth::user()->first_name }}</span>
            </a>
          </li>
          ...
          <li class="nav-item px-3 d-flex align-items-center">
            <a href="javascript:;" class="nav-link text-body p-0" href="{{ route('logout') }}"
