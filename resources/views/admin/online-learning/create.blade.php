...
<div class="card p-4">
    ...
    {!! Form::open(array('route' => 'admin.online-learning.store','method'=>'POST', 'enctype'=>'multipart/form-data')) !!}
    @csrf
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="input-group input-group-outline mb-3">
                ...
                <input type="file" class="form-control @error('video') is-invalid @enderror" name="video" value="{{ old('video') }}" placeholder="{{ __('Upload Video') }}" required autocomplete="off" autofocus>
                @error('video')
                <span class="invalid-feedback" role="alert" align=right>
                    <strong>{{ $message }}</strong>
                </span>
