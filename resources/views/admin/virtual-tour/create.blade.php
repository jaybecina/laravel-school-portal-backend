...
<div class="card p-4">
    ...
    {!! Form::open(array('route' => 'admin.virtual-tour.store','method'=>'POST')) !!}
    @csrf
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="input-group input-group-outline mb-3">
                ...
                <input type="text" class="form-control @error('videoId') is-invalid @enderror" name="videoId" value="{{ old('videoId') }}" placeholder="{{ __('Video ID') }}" required autocomplete="off" autofocus>
                @error('videoId')
                <span class="invalid-feedback" role="alert" align=right>
                    <strong>{{ $message }}</strong>
                </span>
