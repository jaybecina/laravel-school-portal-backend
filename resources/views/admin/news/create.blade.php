...
<div class="card p-4">
    ...
    {!! Form::open(array('route' => 'admin.news.store','method'=>'POST', 'enctype'=>'multipart/form-data')) !!}
    @csrf
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="input-group input-group-outline mb-3">
                ...
                <input type="text" class="form-control @error('author') is-invalid @enderror" name="author" value="{{ old('author') }}" placeholder="{{ __('Author') }}" required autocomplete="off" autofocus>
                @error('author')
                <span class="invalid-feedback" role="alert" align=right>
                    <strong>{{ $message }}</strong>
                </span>
